...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Creating Nairobi neighbourhoods...")
        ...
        for data in neighbourhoods_data:
            ...
            self.stdout.write(f"  Created: {n.name}")

        # --- Real Nairobi Places ---
        self.stdout.write("Creating real Nairobi places...")
        ...
        for data in places_data:
            ...
            if not neighbourhood:
                self.stdout.write(self.style.WARNING(f"  Skipping {data['name']} - neighbourhood not found"))
                continue
        ...
        # --- Transport Edges ---
        self.stdout.write("Creating transport edges...")
        ...
        for origin_name, dest_name, fare, minutes in transport_data:
            ...
            if not TransportEdge.objects.filter(origin=origin, destination=destination).exists():
                ...
                self.stdout.write(f"  Created: {origin_name} → {dest_name}")
